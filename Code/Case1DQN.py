...
#scp /Users/sandyalakkur/Documents/GradSchool/Dissertation/Paper2/Analysis/DenseUnclusteredLowerCullCapacity/RLStuff/ACCREStuff/2_8_18/AtariParams_updatetarget_10kEp.py lakkurss@login.accre.vanderbilt.edu:~/simulations/SpatiallyExplicitDecisions/scripts
#scp /Users/sandyalakkur/Documents/GradSchool/Dissertation/Paper2/Analysis/DenseUnclusteredLowerCullCapacity/RLStuff/ACCREStuff/2_8_18/AtariParams_updatetarget_10kEp.slurm lakkurss@login.accre.vanderbilt.edu:~/simulations/SpatiallyExplicitDecisions/slurm_scripts
...
#THIS IS THE SAME CODE AS ATARIPARAMS_10K BUT I AM UPDATING THE TARGET MODEL TO MATCH THE CURRENT MODEL AT THE END OF EVERY EPISODE, THIS SEEMED TO SHOW PROMISE IN PENLONGERWAIT2000DEQUE_UPDATETARGET_3600 EPISODES, IT PREVENTED TOO MUCH OSCILLATION TOWARDS THE END OF TRAINING.

    #THIS SEEMED TO DO PRETTY WELL, I MIGHT COMPARE TO CULLINFECTEDONLY AND RANDOM. BUT I ALSO WANT TO SEE HOW THE 20K SIMULATION GOES.
...
epsilon_min = 0.01
gamma = 1
coords = np.load('/home/lakkurss/simulations/SpatiallyExplicitDecisions/data/coords10_16_17.npy')
x = coords[:,2]
y = coords[:,3]
gridsquare = coords[:,4]
Cows = np.load('/home/lakkurss/simulations/SpatiallyExplicitDecisions/data/Cows10_16_17.npy')
...
with open('/home/lakkurss/simulations/SpatiallyExplicitDecisions/data/OutbreakParams2_1_18.txt', "rb") as fp: # Unpickling
...
original_pixelarray = np.load('/home/lakkurss/simulations/SpatiallyExplicitDecisions/data/original_pixelarray_10_16_17.npy')
original_currentStatus = np.load('/home/lakkurss/simulations/SpatiallyExplicitDecisions/data/original_currentStatus_10_16_17.npy')
