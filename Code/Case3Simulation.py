...
#Load saved model
model = load_model('/Users/sandyalakkur/Documents/GradSchool/Dissertation/Paper2/Analysis/DenseClusteredLayoutUnifCows/RLStuff/PickNextBestFarm/ACCRE/2_19_18/my_model_AtariParams_updatetarget_10kEp.h5')

#Load coordinate location, farm sizes, Outbreak Parameters, original pixel array, and original status
coords = np.load('/Users/sandyalakkur/Documents/GradSchool/Dissertation/Paper2/Analysis/DenseClusteredLayoutUnifCows/RLStuff/PickNextBestFarm/coords2_17_18.npy') 
x = coords[:,2]
y = coords[:,3]
Cows = np.load('/Users/sandyalakkur/Documents/GradSchool/Dissertation/Paper2/Analysis/DenseClusteredLayoutUnifCows/RLStuff/PickNextBestFarm/Cows2_17_18.npy')
with open("/Users/sandyalakkur/Documents/GradSchool/Dissertation/Paper2/Analysis/DenseClusteredLayoutUnifCows/RLStuff/PickNextBestFarm/OutbreakParams2_17_18.txt", "rb") as fp: # Unpickling
    OutbreakParams = pickle.load(fp)
original_pixelarray = np.load('/Users/sandyalakkur/Documents/GradSchool/Dissertation/Paper2/Analysis/DenseClusteredLayoutUnifCows/RLStuff/PickNextBestFarm/original_pixelarray2_17_18.npy') 
original_currentStatus = np.load('/Users/sandyalakkur/Documents/GradSchool/Dissertation/Paper2/Analysis/DenseClusteredLayoutUnifCows/RLStuff/PickNextBestFarm/original_currentStatus2_17_18.npy') 
...
cull_bridging_when_susceptible_list = []
...
for i in range(2000):
    ...
    cattle_list = []
    dist_list = []
    cull_bridging_when_susceptible = 0
    ...
    while np.sum(pixelarray == 1) > outbreak_thres:
        ...
        if currentStatus[currentAction] == 0:
            ...
            if currentAction == 13 or currentAction == 14:
                cull_bridging_when_susceptible += 1
        ...
        if currentAction in cluster2:
            cluster2_cull_counter += 1
        ...
        #If you have reached daily capacity evolve and cull
            ...
            evolvedStatus = Iterate(newStatus,OutbreakParams,coords[:,2],coords[:,3], bridging_counter)
            #print(evolvedStatus)
    ...
    cluster2_cull_list.append(cluster2_cull_counter)
...
np.save("/Users/sandyalakkur/Documents/GradSchool/Dissertation/Paper2/Analysis/DenseClusteredLayoutUnifCows/RLStuff/PickNextBestFarm/ACCRE/2_19_18/PublicationStuff/new_not_infected.npy",new_not_infected)
