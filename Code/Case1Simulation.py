...
#Load saved model
model = load_model('/Users/sandyalakkur/Documents/GradSchool/Dissertation/Paper2/Analysis/DenseUnclusteredLowerCullCapacity/RLStuff/ACCREStuff/2_8_18/my_model_AtariParams_updatetarget_10kEp.h5')

#Load coordinate location, farm sizes, Outbreak Parameters, original pixel array, and original status
coords = np.load('/Users/sandyalakkur/Documents/GradSchool/Dissertation/Paper2/Analysis/DenseUnclusteredLayoutUnifCows/RLStuff/PickNextBestFarm/ACCREStuff/10_16_17/coords10_16_17.npy') 
x = coords[:,2]
y = coords[:,3]
Cows = np.load('/Users/sandyalakkur/Documents/GradSchool/Dissertation/Paper2/Analysis/DenseUnclusteredLayoutUnifCows/RLStuff/PickNextBestFarm/ACCREStuff/10_16_17/Cows10_16_17.npy')
with open("/Users/sandyalakkur/Documents/GradSchool/Dissertation/Paper2/Analysis/DenseUnclusteredLowerCullCapacity/CullInfectedOnly/OutbreakParams2_1_18.txt", "rb") as fp: # Unpickling
    OutbreakParams = pickle.load(fp)
original_pixelarray = np.load('/Users/sandyalakkur/Documents/GradSchool/Dissertation/Paper2/Analysis/DenseUnclusteredLayoutUnifCows/RLStuff/PickNextBestFarm/ACCREStuff/10_16_17/original_pixelarray_10_16_17.npy') 
original_currentStatus = np.load('/Users/sandyalakkur/Documents/GradSchool/Dissertation/Paper2/Analysis/DenseUnclusteredLayoutUnifCows/RLStuff/PickNextBestFarm/ACCREStuff/10_16_17/original_currentStatus_10_16_17.npy') 
...
np.save("/Users/sandyalakkur/Documents/GradSchool/Dissertation/Paper2/Analysis/DenseUnclusteredLowerCullCapacity/RLStuff/ACCREStuff/2_8_18/PublicationStuff/new_not_infected.npy",new_not_infected)
